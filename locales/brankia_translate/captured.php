...
$Definition['Activity.JoinApproved.FullHeadline'] = '%1$s approvó la cuenta %4$s.';
$Definition['Activity.JoinApproved.ProfileHeadline'] = '%1$s approvó la cuenta %4$s.';
...
$Definition['Activity.JoinInvite.FullHeadline'] = '%1$s aceptó la invitación de %4$s.';
$Definition['Activity.JoinInvite.ProfileHeadline'] = '%1$s aceptó la invitación de %4$s.';
...
$Definition['Back to Discussions'] = 'Volver a Mensajes';
$Definition['Bookmark'] = 'Marcador';
$Definition['bookmarked discussion'] = 'mensaje marcado';
$Definition['Bookmarked Discussions'] = 'Mensajes Marcados';
$Definition['By uploading a file you certify that you have the right to distribute this picture and that it does not violate the Terms of Service.'] = 'Al subir un archivo aceptas que tienes todos los derechos de distribución y que no violas los terminos de uso.';
...
$Definition['Edit My Thumbnail'] = 'Editar mi avatar';
...
%2$s ha creado una cuenta para ti en %3$s. Tus datos de acceso son:
...
$Definition['Enter your existing account password.'] = 'Introduce la contraseña de tu cuenta existente.';
...
$Definition['Start a New Discussion'] = 'Escribir mensaje';
...
$Definition['ValidateConnection'] = 'Los datos introducidos no conectan con la base de datos o son erroneos. La base de datos reportó el siguiente error: <code>%s</code>';
$Definition['ValidateDate'] = '%s no es un dato valido.';
...
$Definition['ValidateLength'] = '%1$s es %2$s demasiado largo.';
$Definition['ValidateMatch'] = 'Los datos no coinciden %s .';
$Definition['ValidateMinimumAge'] = 'Tienes que tener +18 para acceder.';
$Definition['ValidateOneOrMoreArrayItemRequired'] = 'Debes seleccionar al menos un %s.';
...
$Definition['ValidateTime'] = '%s no es una fecha válida.';
$Definition['ValidateTimestamp'] = '%s no es un tiempo válido.';
$Definition['ValidateUsername'] = 'Los nombres de usuario deben tener de 3 a 20 caracteres y pueden estar compuestos de letras, números y guiones(_)';
$Definition['ValidateVersion'] = 'EL campo %s no es una versión válida. Mira un ejemplo de versión válida en la función php version_compare() .';
